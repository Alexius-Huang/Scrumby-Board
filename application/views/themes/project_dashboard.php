...
?>
    ...
    <!-- Load Sweet Alert CSS & JS -->
    <script src="<?php echo base_url(); ?>assets/themes/default/js/sweetalert.min.js"></script>
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/themes/default/css/sweetalert.css">
    ...
    <!-- To import font, use: font-family: 'Fredoka One', cursive; -->
    <link href="https://fonts.googleapis.com/css?family=Maven+Pro" rel="stylesheet">
    <!-- To import font, use: font-family: 'Maven Pro', sans-serif; -->
    <link href="https://fonts.googleapis.com/css?family=Ubuntu+Mono" rel="stylesheet">
    <!-- To import font, use: font-family: 'Ubuntu Mono', monospace; -->
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo '/user/profile/'.$this->session->userdata['id'].'#my_profile'; ?>"
            ><i class="fa fa-user" aria-hidden="true"></i> My Profile</a></li>
            <li><a href="<?php echo '/user/profile/'.$this->session->userdata['id'].'#my_project'; ?>"
            ><i class="fa fa-cube" aria-hidden="true"></i> My Project</a></li>
            <li><a href="<?php echo '/user/profile/'.$this->session->userdata['id'].'#recent_activity'; ?>"
